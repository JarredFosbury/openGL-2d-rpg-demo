...
public class NormalMappedActorLit2DShader extends Shader
{
    ...
    private final int spriteDirection_LOCATION;
    ...
    public NormalMappedActorLit2DShader(String filepath)
    {
        super(filepath);
        maxPointLights = 16;
        ...
        spriteDirection_LOCATION = glGetUniformLocation(getShaderProgramID(), "spriteDirection");
    ...
    public void updateUniforms(Vector4f tint, Matrix4f transform, Matrix4f projection, Matrix4f cameraTransform,
                               Vector2f texPosOffset, Vector2f texPosScale, DirectionalLight dLight, PointLight[] pLights, Vector4f ambientLight, float direction)
    {
        ...
        setFloatUniform(spriteDirection_LOCATION, direction);
